export const en = {
  ...
  auth: {
    ...
    errors: {
      ...
      emailAlreadyInUse: 'Email address is already registered',
    ...
    forgotPasswordScreen: {
      ...
      resendButton: 'Resend after {{seconds}}s',
      limitReached: 'Limit reached',
      backToLogin: 'Back to Login',
      rememberPassword: 'Remember password?',
      attemptsCounter: 'Attempts: {{current}}/{{max}}',
      errors: {
        emailRequired: 'Please enter your email address',
        invalidEmail: 'Please enter a valid email address',
        limitReached: 'You have reached the limit of 3 attempts. Please try again later.',
