export const vi = {
  ...
  auth: {
    ...
    errors: {
      ...
      emailNotFound: 'Địa chỉ email không tồn tại',
      wrongPassword: 'Mật khẩu không chính xác',
      tooManyRequests: 'Quá nhiều lần đăng nhập thất bại. Vui lòng thử lại sau.',
      userDisabled: 'Tài khoản này đã bị vô hiệu hóa',
      emailAlreadyInUse: 'Địa chỉ email đã được đăng ký',
    ...
    forgotPasswordScreen: {
      ...
      sendButton: 'Gửi email đặt lại',
      resendButton: 'Gửi lại sau {{seconds}}s',
      limitReached: 'Đã đạt giới hạn',
      backToLogin: 'Trở về đăng nhập',
      rememberPassword: 'Nhớ mật khẩu?',
      attemptsCounter: 'Lần thử: {{current}}/{{max}}',
      errors: {
        emailRequired: 'Vui lòng nhập địa chỉ email',
        invalidEmail: 'Vui lòng nhập địa chỉ email hợp lệ',
        limitReached: 'Bạn đã đạt giới hạn 3 lần gửi. Vui lòng thử lại sau.',
        waitBeforeResend: 'Vui lòng đợi {{seconds}} giây trước khi gửi lại',
        sendFailed: 'Có lỗi xảy ra khi gửi email. Vui lòng thử lại.',
        emailNotFound: 'Địa chỉ email không tồn tại',
      },
      success: {
        emailSent: 'Email đặt lại mật khẩu đã được gửi. Vui lòng kiểm tra hộp thư của bạn.',
        alertTitle: 'Thành công',
        alertMessage: 'Email đặt lại mật khẩu đã được gửi. Vui lòng kiểm tra hộp thư của bạn.',
      },
    },
  },
  settings: {
  ...
  devices: {
    ...
    thresholds: {
      title: 'Ngưỡng cảnh báo',
      crying: 'Ngưỡng khóc',
      cryingDescription: 'Ngưỡng cảnh báo khi bé khóc tính bằng giây',
      side: 'Ngưỡng nằm nghiêng',
      sideDescription: 'Ngưỡng cảnh báo khi bé nằm nghiêng tính bằng giây',
      prone: 'Ngưỡng nằm sấp',
      proneDescription: 'Ngưỡng cảnh báo khi bé nằm sấp tính bằng giây',
      noBlanket: 'Ngưỡng không đắp chăn',
